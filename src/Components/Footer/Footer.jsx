      ...
      <div className="sb__footer section__padding">
        <div className="sb__footer-links">
          ...
          <div className="sb__footer-section">
            ...
            <p style={{ marginRight: '10px' }}><img src={facebook_icon} alt="" style={{ width: '30px', height: '30px' }} /></p>
          ...
          <a href="/Beirut">
            ...
            <p style={{ color: '#cc2448', textDecoration: 'underline' }}>
              <a href="tel:+9611833217" style={{ color: 'darkpink', fontWeight: 'bold', textDecoration: 'none', borderBottom: '2px solid darkpink' }}>+961 1 83 32 17</a>
            </p>
          </a>
          <a href="/Istanbul">
